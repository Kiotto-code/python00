...
def main():
    ...
    even_numbers = list(ft_filter(is_even, ft_list))
    odd_numbers = list(ft_filter(lambda x: x % 2 != 0, ft_list))
    print("Even ft_list:", even_numbers)
    print("Odd ft_list:", odd_numbers)

    even_numbers = list(ft_filter(is_even, ft_tuple))
    odd_numbers = list(ft_filter(lambda x: x % 2 != 0, ft_tuple))
    print("Even ft_tuple:", even_numbers)
    print("Odd ft_tuple:", odd_numbers)
    
    even_numbers = list(ft_filter(is_even, ft_set))
    odd_numbers = list(ft_filter(lambda x: x % 2 != 0, ft_set))
    print("Even ft_set:", even_numbers)
    print("Odd ft_set:", odd_numbers)
    
    # ft_filter(None, None)
    # ft_filter(is_even, None)
    print(list(ft_filter(None, ft_list)))
